...
<html lang="pt-br">
	<head>
        ...
        <style>
            ...
            body {
                background-image: linear-gradient(white,#e0f3fb);
			...
			<div class="c_container">
				...
				<form method="POST" action="atualizar.php">
					...
					<tr>
						...
						<td><input type="text" name="tabela" value="<?php echo $row_usuario['consulting_table'] ?>" class="form-dia"></td>  
						<td><input type="text" name="situacao" value="<?php echo $row_usuario['consulting_status'] ?>" class="form-dia"></td>
						<td><input type="text" name="ocultar" value="<?php echo $row_usuario['old_consulting'] ?>" class="form-dia"></td>
						<td><input type="text" name="leads" value="<?php echo $row_usuario['default_count'] ?>" class="form-dia" readonly></td>
						<td><input type="text" name="prioritarios" value="<?php echo $row_usuario['priority_count'] ?>" class="form-dia" readonly></td>
					</tr>
					</table>
					<br>
					<table border="0">
